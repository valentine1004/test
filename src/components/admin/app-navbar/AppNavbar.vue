    ...
    <div class="app-navbar__content row">
      <div class="app-navbar__menu-container">
        ...
        <router-link class="app-navbar__logo mr-3" to="/">
          <div class="app-navbar__logo-icon" />
        </router-link>
      </div>
      <app-navbar-actions class="app-navbar__actions md5 lg4" :user-name="userName" :is-top-bar.sync="isTopBarProxy" />
    </div>
...
.app-navbar {
  ...
  &__logo {
    ...
    &-icon {
      background-image: url(~@/assets/icons/MyWaterAdmin_logo.svg);
