<template>
  <div class="app-navbar-actions">
    ...
    <profile-dropdown @choose="profileChoosen" class="app-navbar-actions__item app-navbar-actions__item--profile">
      <span>{{ userName }}</span>
    </profile-dropdown>
  </div>
</template>
...
export default {
  ...
  components: {
    ...
    LanguageDropdown: () => import('./dropdowns/LanguageDropdown'),
    ProfileDropdown: () => import('./dropdowns/ProfileDropdown'),
  },
  props: {
    userName: {
      type: String,
  ...
  methods: {
    ...mapActions(['signOut']),
    profileChoosen(option) {
      if (option.name === 'logout') this.signOut()
